#############################################################################
# Makefile for building: TGMT
# Generated by qmake (3.1) (Qt 5.10.1)
# Project:  ../TGMT-linux/TGMT.pro
# Template: app
# Command: /home/vuthienan178/Qt/5.10.1/gcc_64/bin/qmake -o Makefile ../TGMT-linux/TGMT.pro -spec linux-g++
#############################################################################
...
INCPATH       = -I../TGMT-linux -I. -isystem /usr/local/include/opencv -isystem /usr/include/tesseract -I../../Qt/5.10.1/gcc_64/include -I../../Qt/5.10.1/gcc_64/include/QtCore -I. -I../../Qt/5.10.1/gcc_64/mkspecs/linux-g++
QMAKE         = /home/vuthienan178/Qt/5.10.1/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/vuthienan178/Qt/5.10.1/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/vuthienan178/Qt/5.10.1/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
...
COMPRESS      = gzip -9f
DISTNAME      = TGMT1.0.0
DISTDIR = /home/vuthienan178/Downloads/build-TGMT-Desktop_Qt_5_10_1_GCC_64bit-Release/.tmp/TGMT1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/home/vuthienan178/Qt/5.10.1/gcc_64/lib
LIBS          = $(SUBLIBS) -L/usr/local/lib -lopencv_core -lopencv_imgcodecs -lopencv_highgui -lopencv_imgproc -L/usr/lib -ltesseract -L/home/vuthienan178/Qt/5.10.1/gcc_64/lib -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = ../TGMT-linux/main.cpp \
		../TGMT-linux/utility.cpp \
		../TGMT-linux/cutimage.cpp \
		../TGMT-linux/image.cpp \
		../TGMT-linux/stdafx.cpp \
		../TGMT-linux/mapping.cpp 
OBJECTS       = main.o \
		utility.o \
		cutimage.o \
		image.o \
...
DIST          = ../../Qt/5.10.1/gcc_64/mkspecs/features/spec_pre.prf \
		...
		../TGMT-linux/TGMT.pro ../TGMT-linux/utility.h \
		../TGMT-linux/handlingdefine.h \
		../TGMT-linux/image.h \
		../TGMT-linux/stdafx.h ../TGMT-linux/main.cpp \
		../TGMT-linux/utility.cpp \
		../TGMT-linux/cutimage.cpp \
		../TGMT-linux/image.cpp \
		../TGMT-linux/stdafx.cpp \
...
Makefile: ../TGMT-linux/TGMT.pro ../../Qt/5.10.1/gcc_64/mkspecs/linux-g++/qmake.conf ../../Qt/5.10.1/gcc_64/mkspecs/features/spec_pre.prf \
		../../Qt/5.10.1/gcc_64/mkspecs/common/unix.conf \
		../../Qt/5.10.1/gcc_64/mkspecs/common/linux.conf \
		../../Qt/5.10.1/gcc_64/mkspecs/common/sanitize.conf \
		../../Qt/5.10.1/gcc_64/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile ../TGMT-linux/TGMT.pro -spec linux-g++
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ../TGMT-linux/utility.h ../TGMT-linux/handlingdefine.h ../TGMT-linux/image.h ../TGMT-linux/stdafx.h $(DISTDIR)/
	$(COPY_FILE) --parents ../TGMT-linux/main.cpp ../TGMT-linux/utility.cpp ../TGMT-linux/cutimage.cpp ../TGMT-linux/image.cpp ../TGMT-linux/stdafx.cpp ../TGMT-linux/mapping.cpp $(DISTDIR)/
...
main.o: ../TGMT-linux/main.cpp ../TGMT-linux/handlingdefine.h \
		../TGMT-linux/image.h \
		../TGMT-linux/stdafx.h \
		../TGMT-linux/utility.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o ../TGMT-linux/main.cpp

utility.o: ../TGMT-linux/utility.cpp ../TGMT-linux/utility.h \
		../TGMT-linux/stdafx.h \
		../TGMT-linux/image.h \
		../TGMT-linux/handlingdefine.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o utility.o ../TGMT-linux/utility.cpp

cutimage.o: ../TGMT-linux/cutimage.cpp ../TGMT-linux/stdafx.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o cutimage.o ../TGMT-linux/cutimage.cpp

image.o: ../TGMT-linux/image.cpp ../TGMT-linux/image.h \
		../TGMT-linux/stdafx.h \
		../TGMT-linux/handlingdefine.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o image.o ../TGMT-linux/image.cpp

stdafx.o: ../TGMT-linux/stdafx.cpp ../TGMT-linux/stdafx.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o stdafx.o ../TGMT-linux/stdafx.cpp

mapping.o: ../TGMT-linux/mapping.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mapping.o ../TGMT-linux/mapping.cpp
